...
# Data:
fundos1 = ['KNCR11.SA', 'VGIR11.SA', 'HGCR11.SA', 'BTCI11.SA', 'KNUQ11.SA',
           'KNSC11.SA', 'XPCI11.SA', 'RZTR11.SA', 'MXRF11.SA', 'TRXF11', 
           'KNRI11.SA', 'HGLG11.SA', 'LVBI11.SA', 'BRCO11.SA', 'BTLG11.SA',
           'RZTR11.SA']
fundos2 = ['JURO11.SA', 'IFRA11.SA', 'KDIF11.SA', 'CDII11.SA', 'IFRI11.SA',
           'BODB11.SA', 'OGIN11.SA', 'CDII11.SA', 'CPTI11.SA', 'CRAA11.SA',
           'KNCA11.SA', 'VCRA11.SA', 'RZAG11.SA']
...
# Page
def cs_body():
    st.header(':green[At a Glance]', divider='rainbow')
    if st.button('GO'):
